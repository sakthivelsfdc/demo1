...
// importing accounts
import getAccountList from '@salesforce/apex/lwcController.getAccounts';
...
let pdfString = 'Testing by sakthi';
let bin = atob(pdfString);
// Creating anchor element to download
let downloadElement = document.createElement('a');

// This  encodeURI encodes special characters, except: , / ? : @ & = + $ # (Use encodeURIComponent() to encode these characters).
downloadElement.href = 'data:application/pdf;base64,${bin}';
// CSV File Name
